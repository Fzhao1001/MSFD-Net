...
dataset=opt.task
haze_dir = r'D:\low_light\dataset\LOLV1\test\low\\'
clear_dir = r'D:\low_light\dataset\LOLV1\test\high\\'
model_dir = r"D:\low_light\Low_net1\trained_models\mfediff\LoLv1_p23.054s0.816m.pt"
...
for im in os.listdir(haze_dir):
    ...
    imc = im.split('\\')[-1] #修改
    clear = Image.open(os.path.join(clear_dir, imc)).convert('RGB')
    haze1 = tfs.Compose([
        #tfs.Resize((256,256)),
        tfs.ToTensor(),
